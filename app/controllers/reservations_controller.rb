class ReservationsController < ApplicationController
  ...
  def create
    ...
    if current_user == @listing.user
      ...
      # 【学習】redirect_to :backは古いのでもう使えない。
      # 　元のページにリダイレクトしたいときはredirect_backを使用する
  ...
  private
    def reservation_params
      params.require(:reservation).permit(:start_date, :end_date, :price_pernight, :tortal_price, :listing_id)
    end
